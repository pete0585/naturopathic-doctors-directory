...
export const metadata: Metadata = {
    ...
    description: 'Find licensed naturopathic doctors in Los Angeles, California. Browse top-rated NDs in LA, Santa Monica, Culver City, Pasadena, and the greater Los Angeles area.',
...
export default async function BestNDsLosAngeles() {
    ...
    return (<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <Link href="/cities/los-angeles-ca" className="text-brand-primary font-medium hover:underline">
