...
export const metadata: Metadata = {
    ...
    description: 'Find licensed naturopathic doctors in Salt Lake City, Utah. Browse top-rated NDs in Salt Lake City, Sandy, Draper, and the greater Wasatch Front.',
...
export default async function BestNDsSaltLakeCity() {
    ...
    return (<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <Link href="/cities/salt-lake-city-ut" className="text-brand-primary font-medium hover:underline">
