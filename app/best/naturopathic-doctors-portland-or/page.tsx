...
export const metadata: Metadata = {
    ...
    description: 'Portland, Oregon has one of the highest concentrations of licensed naturopathic doctors in the country. Browse top-rated NDs in Portland and find one accepting new patients.',
...
export default async function BestNDsPortland() {
    ...
    return (<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <Link href="/cities/portland-or" className="text-brand-primary font-medium hover:underline">
