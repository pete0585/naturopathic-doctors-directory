...
export const metadata: Metadata = {
    ...
    description: 'Find licensed naturopathic doctors in San Diego, CA. Browse NDs in San Diego, La Jolla, Chula Vista, Escondido, Carlsbad, and surrounding communities.',
    ...
    return (<>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {top.length > 0 ? (<>
            ...
            <Link href="/listings?state=CA" className="bg-brand-primary text-white font-semibold px-5 py-2.5 rounded-lg hover:bg-brand-primary-dark transition-colors inline-block">
              Browse California NDs
            </Link>
          </div>)}

        <div className="text-center mb-12">
          <Link href="/listings?state=CA" className="text-brand-primary font-medium hover:underline">
