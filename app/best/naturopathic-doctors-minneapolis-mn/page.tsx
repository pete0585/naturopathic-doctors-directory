...
export const metadata: Metadata = {
    ...
    description: 'Find licensed naturopathic doctors in Minneapolis, MN. Browse LNDs across the Twin Cities metro — Minneapolis, St. Paul, Bloomington, Eden Prairie, and surrounding suburbs.',
    ...
    return (<>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {top.length > 0 ? (<>
            ...
            <Link href="/listings?state=MN" className="bg-brand-primary text-white font-semibold px-5 py-2.5 rounded-lg hover:bg-brand-primary-dark transition-colors inline-block">
              Browse Minnesota NDs
            </Link>
          </div>)}

        <div className="text-center mb-12">
          <Link href="/listings?state=MN" className="text-brand-primary font-medium hover:underline">
        ...
        <div className="space-y-5 mb-10">
          ...
          {faqSchema.mainEntity.map((faq) => (<div key={faq.name} className="bg-white rounded-xl border border-gray-200 p-5">
