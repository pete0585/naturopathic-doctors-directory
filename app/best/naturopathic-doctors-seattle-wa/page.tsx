...
export const metadata: Metadata = {
    ...
    description: 'Washington state has licensed naturopathic medicine since 1919. Browse top-rated naturopathic doctors in Seattle, WA — filter by specialty, telemedicine, and availability.',
...
export default async function BestNDsSeattle() {
    ...
    return (<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <Link href="/cities/seattle-wa" className="text-brand-primary font-medium hover:underline">
