...
export const metadata: Metadata = {
    ...
    description: 'Find licensed naturopathic doctors in Denver, Colorado. Browse top-rated NDs in Denver, Boulder, Fort Collins, and the greater Front Range.',
...
export default async function BestNDsDenver() {
    ...
    return (<div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <Link href="/cities/denver-co" className="text-brand-primary font-medium hover:underline">
